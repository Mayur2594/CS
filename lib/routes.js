...
module.exports = {
    ...
    configure: function (app) {
		...
		/* AGENTS DETAILS */
			...
			app.post('/api/ActiveDeactiveFeatures',function (req, res) {
            security(req,res);cs.ActiveDeactiveFeatures(req, res);
			});
			
			app.post('/api/SaveMemberAsAgent',function (req, res) {
            security(req,res);cs.SaveMemberAsAgent(req, res);
			});
			
			app.get('/api/ListAgents',function (req, res) {
            security(req,res);cs.ListAgents(req, res);
			});
			
			app.get('/api/GetAgentsDetails/:agentid',function (req, res) {
            security(req,res);cs.GetAgentsDetails(req, res);
			});
