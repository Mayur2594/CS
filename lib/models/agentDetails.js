...
var agentDetails = new Schema(
{
	...
	groupname:{ type: Schema.Types.ObjectId, ref: 'membersDetails' },
	areaname:{ type: Schema.Types.ObjectId, ref: 'membersDetails' },
	branchname:{ type: Schema.Types.ObjectId, ref: 'membersDetails' },
	createdby:String,
	createddate:Date
});
