...
var accountPlans = new Schema(
{
	...
	actypeid:{accounttype:{ type: String, get: decrypt, set: encrypt},id:{type:String},_id:{type:String},interestrate:{ type: String, get: decrypt, set: encrypt},guarantor:{ type: String, get: decrypt, set: encrypt},installments:{ type: String, get: decrypt, set: encrypt}},
